...
# {
    ...
    latest = (asmt.sort_values(["student_id","subject","season","test_date"]).drop_duplicates(["student_id","subject","season"], keep="last"))
...
# {
    ...
    # {
        passed = False
        tips.append("5a returned no rows (set sql_5a and run).")
    # }
    ...
    # {
        ...
        if (not need_a.issubset(cand_a.columns)) :
            passed = False
            tips.append("5a missing required columns.")
        ...
        # {
            ...
            # {
                passed = False
                tips.append("5a coverage mismatch (NaNs after join).")
            # }
            ...
            # {
                ...
                # {
                    passed = False
                    tips.append("5a spring_tested differs from expected.")
                # }
                ...
                # {
                    passed = False
                    tips.append("5a spring_prof_rate differs beyond tolerance (1e-3).")
                # }
    ...
    # {
        passed = False
        tips.append("5b returned no rows (set sql_5b and run).")
    # }
    ...
    # {
        ...
        # {
            passed = False
            tips.append("5b missing required columns.")
        # }
        ...
        # {
            ...
            # {
                passed = False
                tips.append("5b coverage mismatch (NaNs after join).")
            # }
            ...
            # {
                ...
                # {
                    passed = False
                    tips.append("5b enrollees or seats differ from expected.")
                # }
                ...
                # {
                    passed = False
                    tips.append("5b fill_rate differs beyond tolerance (1e-3).")
                # }
    ...
    print(passed, "Task 5 — SQL Companion", tips)
# }
...
# {
    ...
    print(False, "Task 5 — SQL Companion", ["Run the SQL helper cell first."])
# }