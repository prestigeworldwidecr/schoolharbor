...
# {    
    ...
    if (req.issubset(ada_by_school_month.columns)) :
    ...
    # {
        return print(False, "Task 4 — ADA by School-Month", ["Missing:", sorted(req - set(ada_by_school_month.columns))])
    # }
    ...
    ref = (att.groupby(["school","year_month"], dropna=False)["present"].agg(present_days="sum", marked_days="count").reset_index())
    ...
    # {
        ...
        return print(False, "Task 4 — ADA by School-Month", ["Coverage mismatch (NaNs after join)."])
    # }
    ...
    # {
        passed = False
        tips.append("present_days/marked_days counts differ from expected.")
    # }
    ...
    # {
        passed = False
        tips.append("ADA differs from expected beyond tolerance (1e-3).")
    # }
    ...
    print(passed, "Task 4 — ADA by School-Month", tips)
# }
